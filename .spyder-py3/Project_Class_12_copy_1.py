# -*- coding: utf-8 -*-
"""
Created on Sat Feb 19 17:44:45 2022
...
con=ms.connect(host='localhost',user='root',password='root',database='sk')
cursor=con.cursor()
ctr=0
bank=1
while bank==1:
    print('>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>')
    print("WELCOME TO INDIAN NATIONAL BANK ONLINE PORTAL")
    print('>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>')
    ...
    if choice==1:
        def welcome_message():
            print('>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>')
            print('WELCOME TO INDIAN NATIONAL BANK')
            print('>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>')
        def login():
            while True:
                    ...
                    if ch==1:
                        ...
                        if condition=='false':
                            ...
                            if cho==1:
                                ...
                                print("INDIAN NATIONAL BANK charges an Interest of 7% on loans")
                        ...
                        if condition=='false':
                            ...
                            if cho==1:
                                ...
                                if ty=='car':
                                    ...
                                    print("INDIAN NATIONAL BANK gives Insurance for cars of: ",ins)
                                    ...
                                    print('>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>')
                                    ina=((ins/5)/15)
                                    print("INDIAN NATIONAL BANK gives Insurance for bikes of: ",ins)
                                    print("Your Requested Insurance Claim Amount has to be paid yearly")
                                    print("Amount to pay the for Insurance Claim Amount per year: ",ina)
                                    loa=input("Do you want to continue the Insurance Claim application?(y/n): ")
                                    if loa=='y':
                                ...
                                print('>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>')
                                ina=(ins/12)-(ins/20)
                                print("INDIAN NATIONAL BANK gives Life Insurance of: ",ins)
                                print("Your Requested Insurance Claim Amount has to be paid yearly")
                                print("Amount to pay the for Insurance Claim Amount per year: ",ina)
                                loa=input("Do you want to continue the Insurance Claim application?(y/n): ")
                                if loa=='y':
                                ...
                                print('>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>')
                                ina=(ins/12)/7
                                print("INDIAN NATIONAL BANK gives Property Insurance of: ",ins)
                                print("Your Requested Insurance Claim Amount has to be paid yearly")
                                print("Amount to pay the for Insurance Claim Amount per year: ",ina)
                                loa=input("Do you want to continue the Insurance Claim application?(y/n): ")
                                if loa=='y':
                                ...
                                print('>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>')
                                ina=(ins/12)/7
                                print("INDIAN NATIONAL BANK gives Business Liability Insurance of: ",ins)
                                print("Your Requested Insurance Claim Amount has to be paid yearly")
                                print("Amount to pay the for Insurance Claim Amount per year: ",ina)
                                loa=input("Do you want to continue the Insurance Claim application?(y/n): ")
                                if loa=='y':
